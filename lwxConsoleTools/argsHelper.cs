...
namespace lwxConsoleTools
{
    ...
    internal class argsHelper
    {
        ...
        /// <returns></returns>
        internal static string getArgValue(string[] args, string prefix, string key, string keyAlias1 = "", string keyAlias2 = "")
        {
            int len = args.Length;
            string retVal = "";
        ...
        internal static bool doesArgExist(string[] args, string prefix, string key, string keyAlias1 = "", string keyAlias2 = "")
        {
            if (keyAlias1 == "") keyAlias1 = key;
            if (keyAlias2 == "") keyAlias2 = key;
